...
public interface IDNASketcher<S extends DNAPointer> extends Function<S, BaseSequence[]> {
    ...
    record DecodedSketch<S extends DNAPointer>(S sketch, int serializedSize) {
