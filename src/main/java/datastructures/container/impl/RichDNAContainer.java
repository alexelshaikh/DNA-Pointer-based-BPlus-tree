...
public class RichDNAContainer<T> implements DNAContainer {
    ...
    public IDNAFedReference.DNAFedReference<T, DNAPointer.ContainerDNAPointer> putReference(T reference) {
        return putReference(container.registerId(), reference);
    }

    public IDNAFedReference.DNAFedReference<T, DNAPointer.ContainerDNAPointer> putReference(long id, T reference) {
    ...
    public IDNAFedReference.DNAFedReference<T, DNAPointer.ContainerDNAPointer> getReference(DNAPointer.ContainerDNAPointer sketch) {
        return getReference(sketch.id());
    }

    public IDNAFedReference.DNAFedReference<T, DNAPointer.ContainerDNAPointer> getReference(long id) {
        return new IDNAFedReference.DNAFedReference<>(
                new DNAPointer.ContainerDNAPointer(id, container),
                __ -> container.getPayloads(id),
                __ -> coder.decode(container.get(id))
    ...
    public ContainerList<T> getList(DNAPointer.ContainerDNAPointer sketch) {
    ...
    public ContainerArray<T> getArray(DNAPointer.ContainerDNAPointer sketch) {
