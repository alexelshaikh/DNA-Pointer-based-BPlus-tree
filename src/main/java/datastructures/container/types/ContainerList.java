...
public class ContainerList<T> extends IDNAFedReference.DNAFedReference<List<T>, DNAPointer.ContainerDNAPointer> implements Streamable<T> {

    private final Coder<T, BaseSequence> coder;

    public ContainerList(DNAContainer container, DNAPointer.ContainerDNAPointer sketch, Coder<T, BaseSequence> coder) {
        super(
                sketch,
    ...
    public static Iterator<RichListElement> getRichListIterator(DNAPointer.ContainerDNAPointer sketch) {
    ...
    public static List<AddressedDNA> getListOligos(DNAPointer.ContainerDNAPointer sketch) {
    ...
    public static <T> ContainerList<T> putList(DNAContainer container, Coder<T, BaseSequence> coder, long rootId, List<T> list) {
        ...
        return new ContainerList<>(container, new DNAPointer.ContainerDNAPointer(rootId, container), coder);
    }
